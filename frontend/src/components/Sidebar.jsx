...
export default function Sidebar({ isOpen, onToggle, activePage = 'dashboard', onNavigate }) {
  const navItems = [
    {
      id: 'dashboard',
      ...
      <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          {navItems.map((item) => {
            const isActive =
              activePage === item.id ||
              (activePage === 'dashboard' && (item.id === 'dashboard' || item.id === 'overview')) ||
              (activePage === 'overview' && (item.id === 'dashboard' || item.id === 'overview'));
